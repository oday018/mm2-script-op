...
local Window = OrionLib:MakeWindow({IntroText = "Script Made By Rayan oubaca",IntroIcon = "rbxassetid://7733955511",Name = ("Oubacha script"),IntroToggleIcon = "rbxassetid://4335489011",HidePremium = false,SaveConfig = false,IntroEnabled = true,ConfigFolder = "Mm2SHub"})
