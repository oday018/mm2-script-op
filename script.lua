...
print("[ SCRIPTHUNTERS PRIV ]: SCRIPTHUNTERS PRIV MURDER MYSTERY 2 LOADING...")
...
local R3TH = library.new("SCRIPTHUNTERS PRIV                                                                             .gg/mj4V29UChc", 5013109572)
...
function sendnotification(notificationmessage)
    if WVryGeXr38ZZtdJWtrBtyeEKdm9Kkweaxm7tnUpuCcH835AQN2aLxV2NeG76kYZuWnCZz4yRr == true then
        ...
        Notification:Notify(
            {Title = "CHEATHUNTERS PRIV", Description = notificationmessage},
...
Credits:addButton("SCRIPTHUNTERS", function()
    print("SCRIPTHUNTERS")
end)

--------------------------------------------------------------------------------------LOAD----------------------------------------------------------------------------------------
print("[ SCRIPTHUNTERS PRIV ]: Successfully loaded the script!")
